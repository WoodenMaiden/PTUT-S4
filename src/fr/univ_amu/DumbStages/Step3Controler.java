...
public class Step3Controler {
    ...
    void handleDragExit(DragEvent event) {
        drop.setImage(new Image(getClass().getResourceAsStream("resources/Download3.png")));
    }
    ...
    void handleDragOver(DragEvent event) {
        if (event.getDragboard().hasFiles()){
            ...
            drop.setImage(new Image(getClass().getResourceAsStream("resources/DownloadHover3.png")));
        }
        else
            drop.setImage(new Image(getClass().getResourceAsStream("resources/Download3.png")));
    }
